...
export function DiscardResidue({ urbanSolidWasteEnum, isOpen, handleModal, setWastes }: DiscardResidueProps) {
  const [selected, setSelected] = useState<string>('');
  const { fetchFilteredUrbanSolidWastes, filteredUrbanSolidWastes } = useUrbanSolidWaste();
  const { control, setValue, handleSubmit } = useForm<UrbanSolidWasteRequest>({
    mode: 'all',
