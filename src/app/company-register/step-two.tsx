...
import { stylesInit } from "./step-one";
...
import { Address, addressBaseSchema, CompanyType } from "@/utils/types";
...
export default function RegisterCompanyStepTwo() {
    ...
    const onSubmit: SubmitHandler<Address> = async (data: Address) => {
        ...
        const response = await registerCompany(registerFormData as CompanyType);
